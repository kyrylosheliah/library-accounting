...
{
    protected readonly ConfigurationContext _config;

    public DataContext(DbContextOptions<DataContext> options, IOptions<ConfigurationContext> config)
        : base(options)
    {
    ...
    public virtual DbSet<EnrollmentEvent> EnrollmentEvents { get; set; }
